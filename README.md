...
Ваше хранилище использует гибридную структуру **PARA + Zettelkasten**:
...
После онбординга Архитектор создаёт всю структуру папок хранилища, сохраняет ваш профиль, оставляет приветственную заметку — и всё готово к работе.
...
<p align="center">
  ...
  <br><br>
  <a href="docs/getting-started.md"><strong>Начать</strong></a> · <a href="docs/examples.md"><strong>Примеры</strong></a> · <a href="docs/codex-cli.md"><strong>Гайд по Codex CLI</strong></a> · <a href="docs/codex-migration.md"><strong>Миграция на Codex</strong></a> · <a href="docs/agents/architect.md"><strong>Знакомство с агентами</strong></a> · <a href="CONTRIBUTING.md"><strong>Помочь проекту</strong></a>
</p>
